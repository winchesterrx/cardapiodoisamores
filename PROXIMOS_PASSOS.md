...
## Tarefas Pendentes (Integra��o iFood & Relat�rios)

1. **Registro de Adicionais**: Extrair a propriedade 'options' do pedido do iFood e registrar na tabela 'order_item_addons' para aparecer no relat�rio de adicionais mais vendidos.
2. **Registro de Clientes**: Salvar telefone e nome do cliente do iFood na tabela 'customers' para aparecer nos relat�rios de clientes recorrentes.
3. **Sistema de Backup**: Criar um bot�o no painel Admin para gerar e baixar um arquivo de backup do banco de dados (Aiven).

**Perguntas em Aberto:**
- O iFood usa nomes pr�prios para os produtos. Devemos criar uma l�gica para aproximar o nome que vem do iFood com o que est� no seu sistema, ou os relat�rios podem mostrar os nomes exatos do iFood?
